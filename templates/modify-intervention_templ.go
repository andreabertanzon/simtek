...
func ModifyIntervention(intervention data.Intervention) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.JoinStringErrs(interventionPut(intervention))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/modify-intervention.templ`, Line: 13, Col: 40}
		}
		...
		templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.JoinStringErrs(intervention.ToViewModel().Site)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/modify-intervention.templ`, Line: 24, Col: 43}
		}
		...
		templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinStringErrs(intervention.ToViewModel().Intervention)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/modify-intervention.templ`, Line: 34, Col: 45}
		}
		...
		for _, worker := range intervention.ToViewModel().Workers {
			...
			templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(worker)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/modify-intervention.templ`, Line: 45, Col: 19}
			}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</div><button class=\"btn-secondary rounded p-2 mt-2 mb-2 mr-2 text-4xl\" type=\"button\" hx-get=\"/dynamic-input?type=worker\" hx-target=\"#workers-container\" hx-swap=\"beforeend\">+Operatore</button><div class=\"flex flex-col mt-4\" id=\"materials-container\"><p class=\"text-4xl\">Materiali</p>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(intervention.Notes)
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/modify-intervention.templ`, Line: 75, Col: 24}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var6))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</textarea></div><div class=\"flex\"><button class=\"btn-primary rounded p-2 mr-2 mt-2 text-4xl\" type=\"submit\">Avanti</button> <button class=\"rounded border-2 p-2 mt-2 text-4xl btn-outline-danger\" hx-get=\"/\" hx-target=\"#main-content\" hx-boost=\"true\">Annulla</button></div></form>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
