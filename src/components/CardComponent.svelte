...
>
	...
	>
		<h5 class="mb-2 mt-2 text-sm font-bold tracking-tight text-white inline-flex">
	...
	<div class="p-2 bg-white row-span-2">
		<p style="font-weight:normal;" class="pt-4 text-sm">{currentIntervention.description}</p>
	</div>
	<div class="p-2 bg-white rounded-b-lg grid grid-cols-3 content-center justify-items-center">
		<!-- Icon -->
		<div class="mr-2 flex">
			<svg
				xmlns="http://www.w3.org/2000/svg"
		...
		<div class="mr-2 flex">
			...
			<span class="text-base font-normal leading-tight text-gray-500 ml-2"
				>{currentIntervention.spentHours * 30} €</span
			>
		</div>
		<div class="mr-2 flex">
			<svg
			...
			<span class="text-base font-normal leading-tight text-gray-500 ml-2">-</span>
		</div>
	</div>
</div>
